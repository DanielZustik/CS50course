...
void sepia(int height, int width, RGBTRIPLE image[height][width])
{
    for(int i = 0; i < height; i++)
        for(int j = 0; j < width; j++)
        {
            image[i][j].rgbtBlue = (round(0.272 * image[i][j].rgbtBlue + 0.534 * image[i][j].rgbtGreen + 0.131 * image[i][j].rgbtRed) >= 255) ?
                 255 : round(0.272 * image[i][j].rgbtBlue + 0.534 * image[i][j].rgbtGreen + 0.131 * image[i][j].rgbtRed);

            image[i][j].rgbtGreen = (round(0.349 * image[i][j].rgbtBlue + 0.686 * image[i][j].rgbtGreen + 0.168 * image[i][j].rgbtRed) >= 255) ?
                255 : round(0.349 * image[i][j].rgbtBlue+ 0.686 * image[i][j].rgbtGreen + 0.168 * image[i][j].rgbtRed);

            image[i][j].rgbtRed = (round(0.393 * image[i][j].rgbtBlue + 0.769 * image[i][j].rgbtGreen + 0.189 * image[i][j].rgbtRed) >= 255) ?
            255 : round(0.393 * image[i][j].rgbtBlue + 0.769 * image[i][j].rgbtGreen + 0.189 * image[i][j].rgbtRed);
        }
    return;
}
